...
-- utils.nnoremap("<space>e", "<cmd>lua vim.diagnostic.open_float()<CR>")
utils.nnoremap("[d", "<cmd>lua vim.diagnostic.goto_prev()<CR>")
utils.nnoremap("]d", "<cmd>lua vim.diagnostic.goto_next()<CR>")
utils.nnoremap("<space>q", "<cmd>lua vim.diagnostic.setloclist()<CR>")
...
local on_attach = function(client, bufnr)
    ...
    -- vim.api.nvim_buf_set_keymap(bufnr, "n", "gd", jump_to_definition, opts)
