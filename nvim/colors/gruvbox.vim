...
if has("spell")
  ...
  if g:gruvbox_improved_warnings == 0
    ...
    call s:HL('SpellCap',   s:green, s:bg1, s:bold, s:italic)
  endif
  " Not recognized word
  call s:HL('SpellBad',   s:none, s:bg1, s:undercurl, s:blue)
  " Wrong spelling for selected region
  call s:HL('SpellLocal', s:none, s:bg1, s:undercurl, s:aqua)
  " Rare word
  call s:HL('SpellRare',  s:none, s:bg1, s:undercurl, s:purple)
endif
...
hi FzfBg       ctermfg=none  ctermbg=none  cterm=none
hi FzfHl       ctermfg=6     ctermbg=none  cterm=none
hi FzfSBg      ctermfg=none  ctermbg=none  cterm=none
hi FzfSHl      ctermfg=14    ctermbg=none  cterm=none
hi FzfPointer  ctermfg=12    ctermbg=none  cterm=none
hi FzfMarker   ctermfg=12    ctermbg=none  cterm=none
hi FzfBorder   ctermfg=12    ctermbg=none  cterm=none
hi FzfSpinner  ctermfg=12    ctermbg=none  cterm=none
hi FzfInfo     ctermfg=12    ctermbg=none  cterm=none
hi FzfPrompt   ctermfg=13    ctermbg=none  cterm=none
